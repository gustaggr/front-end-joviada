            ...
            <div className="w-full h-full justify-center flex-col items-center flex p-4 mt-10">
                <div className="flex flex-col max-w-[600px] w-full items-start gap-8">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <input required type="text" className="w-full text-lg p-2 bg-backgroundClear rounded-xl outline-none placeholder:text-slate-600 text-black" placeholder="John Doe"></input>
                    </div>
                    <div className="flex flex-col gap-4 w-full">
                        <h2 className="text-black text-sm flex gap-1 font-normal">E-mail<h3 className="text-red-500">*</h3></h2>
                        <input required type="email" className="w-full text-lg p-2 bg-backgroundClear rounded-xl outline-none placeholder:text-slate-600 text-black" placeholder="seunome@hotmail.com"></input>
                    </div>
                    <div className="flex flex-col gap-4 w-full">
