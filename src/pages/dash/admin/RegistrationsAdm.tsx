...
export default function RegistrarionsAdm() {
    ...
    const data = [
        { id: 1, idevent: "RTRJC", name: "John Michael", status: "Pendente", date: "23/04/18", birthday: "12/08/90", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 2, idevent: "RTRJC", name: "Sarah Smith", status: "Aprovado", date: "15/05/20", birthday: "30/11/85", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 3, idevent: "RTRJC", name: "Emma Brown", status: "Recusado", date: "02/03/19", birthday: "08/01/92", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 4, idevent: "RTRJC", name: "Michael Green", status: "Pendente", date: "10/07/21", birthday: "15/09/88", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 5, idevent: "RTRJC", name: "Olivia White", status: "Aprovado", date: "19/08/18", birthday: "03/04/93", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 6, idevent: "RTRJC", name: "David Johnson", status: "Recusado", date: "28/11/19", birthday: "21/07/91", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 7, idevent: "RTRJC", name: "Sophia Lee", status: "Pendente", date: "06/12/17", birthday: "09/05/94", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 8, idevent: "RTRJC", name: "Chris Evans", status: "Aprovado", date: "12/02/22", birthday: "19/10/89", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 9, idevent: "RTRJC", name: "Emily Clark", status: "Recusado", date: "04/09/18", birthday: "26/02/86", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 10, idevent: "RTRJC", name: "Daniel Martinez", status: "Pendente", date: "29/10/20", birthday: "15/12/87", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 11, idevent: "RTRJC", name: "Grace Adams", status: "Aprovado", date: "03/01/19", birthday: "05/08/90", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 12, idevent: "RTRJC", name: "James Wilson", status: "Recusado", date: "08/05/21", birthday: "30/06/95", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 13, idevent: "RTRJC", name: "Anna Roberts", status: "Pendente", date: "21/04/18", birthday: "28/11/88", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 14, idevent: "RTRJC", name: "Lucas Brown", status: "Aprovado", date: "17/03/20", birthday: "17/03/84", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 15, idevent: "RTRJC", name: "Lily Green", status: "Recusado", date: "23/06/19", birthday: "14/07/92", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 16, idevent: "RTRJC", name: "Ethan Thomas", status: "Pendente", date: "15/09/21", birthday: "21/01/91", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 17, idevent: "RTRJC", name: "Zoe White", status: "Aprovado", date: "18/10/18", birthday: "02/03/89", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 18, idevent: "RTRJC", name: "Jack Davis", status: "Recusado", date: "07/11/20", birthday: "22/09/93", type: "Meia", idpgt: "MP234HD23", value: 100 },
        { id: 19, idevent: "RTRJC", name: "Ella King", status: "Pendente", date: "25/07/22", birthday: "19/12/87", type: "Inteira", idpgt: "MP234HD23", value: 200 },
        { id: 20, idevent: "RTRJC", name: "William Scott", status: "Aprovado", date: "14/08/19", birthday: "05/06/90", type: "Meia", idpgt: "MP234HD23", value: 100 }
    ];
                            ...
                            <tbody>
                                {data.map((item) => (
                                    <tr key={item.id} className="hover:bg-slate-50">
                                        ...
                                        <td className="p-4 border-b border-slate-200">
                                            <p className="block text-sm text-slate-800">{item.idevent}</p>
                                        </td>
                                        <td className="p-4 border-b border-slate-200">
                                        ...
                                        <td className="p-4 border-b border-slate-200">
                                            <div className="flex gap-3 items-center">
                                                ...
                                                <FaTrash onClick={deletedTicket} className="cursor-pointer text-red-600" />
                                            </div>
                                        </td>
                                    </tr>
                                ))}
                ...
                <div className="bg-white font-lexend p-8 rounded-lg shadow-md w-[90%] max-w-md">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="grid grid-cols-2 gap-2  max-mb:grid-cols-1">
                                <div className="flex flex-col gap-2">
                                    <h2 className="text-black text-sm flex gap-1 font-normal">
                                ...
                                <div className="flex flex-col gap-2">
                                    <h2 className="text-black text-sm flex gap-1 font-normal">
                                        Tipo<h3 className="text-red-500">*</h3>
                                    </h2>
                                    <select
                                        required
                                        className="w-full text-lg p-2 bg-background rounded-xl outline-none placeholder:text-slate-600 text-black"
                                    >
                                        <option value="volvo">Inteira</option>
                                        <option value="saab">Meia</option>
                                        <option value="saab">Diaria</option>
                                    </select>
                                </div>
                            </div>
                            <div className="flex flex-col gap-2">
