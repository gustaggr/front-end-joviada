        ...
        <>
            <div className="w-screen z-10 bg-backgroundClear h-16 items-center justify-center flex px-5">
                <div className="text-black w-full items-center justify-between flex max-w-[1200px]">
                    <div>
                        <Link to={'/'} className="font-bold text-black text-xl"><img className="w-52" src='/namelogo.svg'/></Link>
                    </div>
            ...
            <div className="w-full z-10 bg-backgroundClear h-16 fixed bottom-0 left-0 flex sm:hidden items-center justify-around text-blac">
                ...
                <a className="flex flex-col items-center">
                    ...
                    <span className="text-xs">Meu Dados</span>
                </a>
            </div>
        </>
    )
